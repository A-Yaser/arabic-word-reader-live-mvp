...
})(UsageDataReportingMethod || (exports.UsageDataReportingMethod = UsageDataReportingMethod = {}));
/**
...
})(UsageDataLevel || (exports.UsageDataLevel = UsageDataLevel = {}));
/**
...
class OfficeAddinUsageData {
    ...
    async reportEvent(_eventName, _data) { }
    /** @deprecated No-op - usage data reporting has been removed */
    async reportEventApplicationInsights(_eventName, _data) { }
    /** @deprecated No-op - usage data reporting has been removed */
    async reportError(_errorName, _err) { }
    /** @deprecated No-op - usage data reporting has been removed */
    async reportErrorApplicationInsights(_errorName, _err) { }
    /** @deprecated No-op - usage data reporting has been removed */
